...
public abstract class Asteroid extends Actor {
    ...
    static final float MIN_ROCK_SPEED =  40.0F / 60;
    static final float MAX_ROCK_SPEED = 240.0F / Game.FPS;
    static final float MAX_ROCK_SPIN  = (float) Math.PI / 60;
    ...
    public Asteroid() {
        ...
        for (int j = 0; j < side; j++) {
            ...
            float radius = MIN_ROCK_SIZE + (int) (Math.random() * (MAX_ROCK_SIZE - MIN_ROCK_SIZE));
        ...
        angle = (float) (Math.random() * 2 * MAX_ROCK_SPIN - MAX_ROCK_SPIN);
        deltaAngle = (float) (Math.random() * 2 * MAX_ROCK_SPIN - MAX_ROCK_SPIN);
        speed=MIN_ROCK_SPEED;
